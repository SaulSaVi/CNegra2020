...
const MONGO_URI = 'mongodb:mongodb://Saul:gregwirt@cinta-negra-shard-00-00-3in8y.mongodb.net:27017,cinta-negra-shard-00-01-3in8y.mongodb.net:27017,cinta-negra-shard-00-02-3in8y.mongodb.net:27017/test?ssl=true&replicaSet=cinta-negra-shard-0&authSource=admin&retryWrites=true&w=majority';
...
mongoose.connect(MONGO_URI, {
  ...
  .catch(() => console.log('Atlas connection error...'));erver.use(express.json({extended:true}));
